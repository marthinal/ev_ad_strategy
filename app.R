...
if (!require("shinylive")) install.packages("shinylive", repos = "http://cran.us.r-project.org")
...
# Guardar como archivo estático HTML con ShinyLive
shinylive::export(
  appdir = getwd(),
  destdir = file.path(getwd(), "shinylive_export"),
  quiet = FALSE
)
