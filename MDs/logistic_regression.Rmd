...
Mi objetivo ha sido ajustar un modelo de regresión logística que permita predecir la acción comercial que se debe tomar dependiendo del porcentaje de carga que un usuario planea cargar en una estación con tasas de carga rápidas (35-100 kW) bsándome en datos historicos del dataset..\
...
| Coeficiente   | Estimate | Std. Error | z value | Pr(\>    |
|---------------|----------|------------|---------|----------|
